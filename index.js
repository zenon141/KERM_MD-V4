...
console.log("CONNECTING KERM_MD-V4 BOT🧬...");
...
let up = `*╭──────────────●●►*
> *➺Kᴇʀᴍ_ᴍᴅ-ᴠ4 ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ Kɢᴛᴇᴄʜ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ᴋᴇʀᴍ_ᴍᴅ-ᴠ4❁*

*https://whatsapp.com/channel/0029Vafn6hc7DAX3fzsKtn45*

> *❁ᴊᴏɪɴ ᴏᴜʀ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ᴋᴇʀᴍ_ᴍᴅ-ᴠ4❁*
...
*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://pomf2.lain.la/f/cdn0360.jpg` }, caption: up })
